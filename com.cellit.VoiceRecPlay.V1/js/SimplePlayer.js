...
com.cellit.VoiceRecPlay.V1.SimplePlayer = function (options) {
    ...
    var window = new Ext.Window({
        ...
        items: [
            new Ext.Panel({
                html: '<audio controls autoplay ><source src="' + options.url + '" type="audio/mpeg">Your browser does not support the audio element.</audio>'
            })
        ]
    });
