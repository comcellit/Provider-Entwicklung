...
namespace com.cellit.MailResultService.V1
{
    ...
    public class MailResultService : IService
    {
        ...
        private int _transRef;
        private int _dateRef;
        private int _timeRef;
        private int _ergRef;
        private int _ipRef;
        private string date;
        private string time;
        ...
        public void SendResultData()
        {
            ...
            string sql = "SELECT ProjektID,transaktionID,vtg_TransRef,KundenID,left(BestaetigungDatum,10) as BestaetigungDatum,vtg_BDatumRef,BestaetigungUhrzeit,vtg_BUhrzeitRef,Ergebnis,vtg_ErgebnisRef,KundenIP,vtg_IPRef,TransaktionEnd FROM _MailProviderTransaktion where TransaktionEnd=1 and RequestEnd=0";
