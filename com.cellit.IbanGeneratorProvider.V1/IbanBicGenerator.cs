...
namespace com.cellit.IbanBicGeneratorProvider.V1
{
    [Provider(DisplayName = "Com.cellit Mask Iban Generator", Description = "Common Provider", Tags = "ttCall4.Mask.Extention" , Category = "Com.cellit Mask")]
    public class IbanBicGenerator : IProvider
    {
        ...
        public List<string> LoadScripts
        {
            get
            {
                ...
                scripts.Add(this.GetProviderDatas().UrlDirectory + "js/IbanGeneratorProvider.js?V=1");
                return scripts;
            }
        }
        ...
        public List<string> RunScripts
        {
            ...
            {
                List<string> scripts = new List<string>();
                scripts.Add("ccom.cellit.IbanBicGeneratorProvider.V1.ProviderInstance = new com.cellit.IbanBicGeneratorProvider.V1.IbanBicProvider(%this%);");
                return scripts;
            }
        }
